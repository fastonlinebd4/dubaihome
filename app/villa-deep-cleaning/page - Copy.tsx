    ...
    <main className="min-h-screen bg-[#fcfcfc] overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                Experience professional villa deep cleaning with Al Rukam's expert team. We transform your luxury villa into a pristine sanctuary using advanced techniques and eco-friendly solutions.
              </p>
      ...
      <section className="py-20 bg-[#fcfcfc] relative overflow-hidden">
        ...
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <p className="text-[#529e00] font-bold text-sm uppercase tracking-widest mb-3">WHY CHOOSE AL RUKAM</p>
            <h2 className="text-3xl md:text-4xl font-black text-[#091a33] mb-4">

...
const services = [
  ...
  },
  {
    ...
    description:
      'Our professional Villa Painting Services in Dubai deliver a smooth, elegant, and long-lasting finish for your home. We use high-quality paints and expert techniques to enhance your villa’s beauty, ensuring clean work, perfect detailing, and a premium look that adds real value to your property.',
    icon: Paintbrush,
  ...
  },
{
  ...
  description:
    'Our professional Outside Power Wash Services in Dubai remove stubborn dirt, dust, stains, mold, and algae from exterior surfaces to restore a clean and refreshed appearance. Using high-pressure washing equipment and safe cleaning techniques, we effectively clean driveways, walls, patios, parking areas, and building exteriors, delivering a powerful and long-lasting finish that enhances your property’s overall look.',
  icon: Waves,
...
},
{
  ...
  description:
    'Our professional Outside Window Cleaning Services in Dubai remove dust, water stains, and outdoor dirt to restore crystal-clear glass and a brighter exterior appearance. Using safe access methods and advanced cleaning tools, we ensure streak-free windows that enhance the overall look of your building while maintaining the highest safety standards.',
  icon: Sparkles,
...
},
{
  ...
  description:
    'Our professional Steam Deep Cleaning Services in Dubai provide deep sanitization using high-temperature steam to eliminate germs, bacteria, allergens, and stubborn stains. This chemical-free cleaning method is ideal for kitchens, bathrooms, upholstery, and high-touch surfaces, ensuring a hygienic, fresh, and safe environment for homes and commercial spaces.',
  icon: Droplets,
...
export default function Services() {
  return (
    <section id="services" className="py-20 bg-[#fafbfc] relative overflow-hidden">
      {/* Soft background glow */}
      <div className="absolute -top-24 -right-24 w-[520px] h-[520px] bg-primary/5 rounded-full blur-[110px] pointer-events-none" />
      <div className="absolute -bottom-28 -left-28 w-[520px] h-[520px] bg-black/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {services.map((service, idx) => {
            ...
            return (
              <Link
                key={idx}
                href={service.href}
                className="group block rounded-[28px] overflow-hidden bg-white shadow-sm hover:shadow-2xl transition-all duration-700 border border-gray-100 hover:border-primary/10"
              >
                {/* Image only */}
                <div className="relative h-[190px] md:h-[200px] overflow-hidden">
                  <Image
                    src={service.image}
                    alt={service.title}
                    fill
                  ...
                  {/* ✅ FIX: Book chip now clickable -> /get-quote */}
                  <Link
                    href="/get-quote"
                    className="absolute top-4 right-4 bg-white/85 hover:bg-primary hover:text-white transition-all duration-300 backdrop-blur-md border border-white/60 rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-gray-900"
                ...
                {/* Text BELOW image inside a nice shape */}
                <div className="relative p-5">
                  {/* Unique “shape” accent */}
                  <div className="pointer-events-none absolute -top-6 left-5 right-5 h-12 rounded-[22px] bg-primary/5" />

                  <div className="relative rounded-[22px] border border-gray-100 bg-white p-4 shadow-[0_10px_30px_rgba(0,0,0,0.04)]">
                    <div className="flex items-start gap-3">
                      <div className="shrink-0 w-11 h-11 rounded-2xl bg-primary/10 border border-primary/10 flex items-center justify-center">
                        <Icon className="w-5 h-5 text-primary" />
                      </div>

                      <div className="min-w-0">
                        <h3 className="text-[15px] font-bold text-gray-900 font-heading leading-snug">
                          {service.title}
                        </h3>

                        <p className="mt-2 text-gray-600 text-[12px] leading-relaxed font-medium">
                          {service.description}
                        </p>

                        <div className="mt-3 inline-flex items-center gap-2 text-primary font-bold text-[12px]">
                          View Details
        ...
        <div className="mt-16 text-center">
          <Button
            asChild
            variant="outline"
            className="rounded-full h-12 px-10 border-gray-200 font-bold uppercase tracking-widest text-[10px] hover:bg-gray-50 transition-all"
          >
